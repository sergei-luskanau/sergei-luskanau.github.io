...
var clockSettings = {
    ...
    contentWidth: 700, // px Width of the content
    ...
    fallback: '705x255.png', /* set the fallback image name (place the file in the img folder)*/
    trackingurl: 'http://www.rolex.com/fr?cmpid=dw_Clocks_201600413', /* set the tracking url */
    leadingZeros: true,
