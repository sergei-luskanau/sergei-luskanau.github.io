...
var rolexClockScale = {
    ...
    180: {width: 180, height: 180, scale: 2.1},// scale 2.1
    300: {width: 259, height: 260, scale: 2.2}// scale 1.2
}
var dim = rolexClockScale[180];
...
var clockSettings = {
    ...
    contentWidth: 600, // px Width of the content
    contentHeight: 200, // px Height of the content
    ...
    fallback: '600x200.png', /* set the fallback image name (place the file in the img folder)*/
    trackingurl: 'http://www.rolex.com/fr?cmpid=dw_Clocks_201600417', /* set the tracking url */
    leadingZeros: true,
    amPm: true, /* display AM/PM text */
    time24hours: false, /* display time in 24 hours format */
    showText: true, /* display texts and time */
    showTime: true, /* display time without city name, 'Your Time' text */
